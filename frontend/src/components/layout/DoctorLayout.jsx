...
import {
    FaTachometerAlt, FaCalendarAlt, FaUserEdit,
    FaSignOutAlt, FaBars, FaUserMd, FaDollarSign, FaMoneyBillWave,
    FaComments,
} from 'react-icons/fa';
...
const DoctorLayout = () => {
    ...
    const navItems = [
        ...
        { to: '/doctor/chat', icon: FaComments, label: 'Chats', badge: totalUnread },
        { to: '/doctor/earnings', icon: FaDollarSign, label: 'Earnings' },
        { to: '/doctor/payouts', icon: FaMoneyBillWave, label: 'Payouts' },
        { to: '/doctor/profile', icon: FaUserEdit, label: 'My Profile' },
    ];
        ...
        <aside className="flex flex-col h-full bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 w-60">
            ...
            <div className="px-4 py-4 border-t border-gray-100 dark:border-gray-700">
                <div className="flex items-center gap-3 mb-3">
                    <img
                        src={user?.avatar?.url || `https://ui-avatars.com/api/?name=${encodeURIComponent(user?.name || 'D')}&background=2563eb&color=fff&size=36`}
                        alt={user?.name}
        ...
        <div className="flex h-screen bg-gray-50 dark:bg-gray-900 overflow-hidden">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                <div className="md:hidden flex items-center justify-between px-4 py-3 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <span className="font-bold text-blue-600">Doctor Portal</span>

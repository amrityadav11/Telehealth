...
const DoctorChat = () => {
    ...
    const { inbox, activeConversation } = useSelector((s) => s.chat);
    ...
    // If URL has appointmentId, auto-select that conversation
    useEffect(() => {
    ...
    // Check online status of all inbox users when inbox loads
    useEffect(() => {
    ...
    const handleSelectConversation = useCallback((conv) => {
        ...
        setMobileView('chat');
        navigate(`/doctor/chat/${conv.appointmentId}`, { replace: true });
    }, [dispatch, navigate]);
